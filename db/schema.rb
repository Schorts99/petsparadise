...
ActiveRecord::Schema.define(version: 20170101230021) do
  ...
  create_table "managers", force: :cascade do |t|
    ...
    t.string   "reference_phone2"
    t.boolean  "bad",                         default: false
    t.boolean  "conditions",                  default: false
    t.string   "country"
    t.string   "state"
    t.string   "city"
    t.string   "suburb"
    ...
    t.string   "vitae_file_name"
    t.string   "vitae_content_type"
    t.integer  "vitae_file_size"
    t.datetime "vitae_updated_at"
